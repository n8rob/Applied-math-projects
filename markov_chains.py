...
if __name__ == '__main__':
    print("Functions to choose from:")
    print("- random_chain(n): creates a random transition matrix with n states")
    print("- forecast(days): gives a list of day-to-day weather predictions (each day hot or cold)")
    print("- four_state_forecast(days): gives a list of day-to-day weather predictions (each day hot, mild, cold, or freezing)")
    print("- steady_state(A): finds the steady state of a transition matrix")
    print("And within the SentenceGenerator class the following methods:")
    print("- babble(): generates fake English sentences from the distribution of words in the uploaded corpus")
    print("Feel free to pass any of these files through the SentenceGenerator class or a corpus of your own....")
    print("- yoda.txt")
    print("- tswift1989.txt")
    print("- trump.txt")
